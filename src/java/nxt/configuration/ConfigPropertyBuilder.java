...
public class ConfigPropertyBuilder {
    ...
    public ConfigPropertyBuilder setMin(Integer min) {
        if (this.type != INTEGER) {
            throw new UnsupportedOperationException("setMin is supported only for integer properties");
        }
        this.min = min;
        return this;
    }
    ...
    public ConfigPropertyBuilder setMax(Integer max) {
        if (this.type != INTEGER) {
            throw new UnsupportedOperationException("setMax is supported only for integer properties");
        }
        this.max = max;
        return this;
    }
