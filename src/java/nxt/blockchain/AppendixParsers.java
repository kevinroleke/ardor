...
public final class AppendixParsers {
    ...
    static {
        ...
        map.put(AtomicChildAppendix.appendixType, AtomicChildAppendix.appendixParser);
        map.put(AtomicParentAppendix.appendixType, AtomicParentAppendix.appendixParser);
