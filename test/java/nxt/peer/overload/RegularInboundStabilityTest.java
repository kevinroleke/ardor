...
public class RegularInboundStabilityTest extends AbstractPeersTest {
    ...
    public static void init() throws InterruptedException, IOException {
        ...
        net1.addOverloadTest(Overload.Name.CONNECTOBOT, testDuration, false, false, false, true, useInternalWorkpool, numThreads, 100, false);
        net2.addOverloadTest(Overload.Name.CONNECTOBOT, testDuration, false, false, false, true, useInternalWorkpool, numThreads, 100, false);
        net3.addOverloadTest(Overload.Name.CONNECTOBOT, testDuration, false, false, false, true, useInternalWorkpool, numThreads, 100, false);
        net4.addOverloadTest(Overload.Name.CONNECTOBOT, testDuration, false, false, false, true, useInternalWorkpool, numThreads, 100, false);

        /** name, runtime, alwaysOverload, randomOverload, useInternalWorkPool, maxThreads, disconnectDelay, doInvoke */
        net1.addOverloadTest(Overload.Name.DISCONNECTOBOT, testDuration, false, false, useInternalWorkpool, numThreads, 133, false);
        net2.addOverloadTest(Overload.Name.DISCONNECTOBOT, testDuration, false, false, useInternalWorkpool, numThreads, 133, false);
        net3.addOverloadTest(Overload.Name.DISCONNECTOBOT, testDuration, false, false, useInternalWorkpool, numThreads, 133, false);
        net4.addOverloadTest(Overload.Name.DISCONNECTOBOT, testDuration, false, false, useInternalWorkpool, numThreads, 133, false);

        /** name, runtime, numMessages, delay, useInternalWorkPool, maxThreads, sendDelay, doInvoke */
        net1.addOverloadTest(Overload.Name.SENDOBOT, testDuration, 10, 0, useInternalWorkpool, numThreads, 7, false);
        net2.addOverloadTest(Overload.Name.SENDOBOT, testDuration, 10, 0, useInternalWorkpool, numThreads, 8, false);
        net3.addOverloadTest(Overload.Name.SENDOBOT, testDuration, 10, 0, useInternalWorkpool, numThreads, 9, false);
        net4.addOverloadTest(Overload.Name.SENDOBOT, testDuration, 10, 0, useInternalWorkpool, numThreads, 10, false);

        /** name, runtime, numRequests, useInternalWorkPool, maxThreads, sendDelay, doInvoke */
        net1.addOverloadTest(Overload.Name.REQUESTOBOT, testDuration, 10, useInternalWorkpool, numThreads, 8, false);
        net2.addOverloadTest(Overload.Name.REQUESTOBOT, testDuration, 10, useInternalWorkpool, numThreads, 9, false);
        net3.addOverloadTest(Overload.Name.REQUESTOBOT, testDuration, 10, useInternalWorkpool, numThreads, 10, false);
        net4.addOverloadTest(Overload.Name.REQUESTOBOT, testDuration, 10, useInternalWorkpool, numThreads, 11, false);
    ...
    @Test
    public void regularInboundStabilityTest() throws InterruptedException {
